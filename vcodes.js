...
module.exports = class VOID {
  ...
  serverCount(message) {
  fetch(`https://finnworld.tk/api/bots/stats`, {
        method: 'POST',
        headers: { 
  ...
  async search(id) {
  return await fetch(`https://finnworld.tk/api/bots/${id}`, {
        method: 'GET'
    })
  ...
  async hasVoted(id) {
  return await fetch(`https://finnworld.tk/api/bots/check/${id}`, {method: 'GET',headers: { 
